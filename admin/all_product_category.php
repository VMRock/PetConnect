                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">All Product Category</h4>
                                                </div>
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>No products category</center></td>';
														}
													else
														{				
																		...
																		{			
																				$mql="SELECT * FROM pet_category where category_id='".$rows['category_id']."'";
																					...
																					echo ' <tr><td>'.$row['category_name'].'</td>
																								...
																								<center><img src="admin_img/'.$rows['image'].'" class="img-responsive radius"  style="min-width:150px;min-height:100px;"/></center>
																								</div></td>
																								
																								<td>'.$rows['date'].'</td>
																									 <td><a href="delete.php?product_category_del='.$rows['product_category_id'].'" onclick="return confirmDelete();" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_product_category.php?product_category_upd='.$rows['product_category_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';										
																		}	
														}
											?>
