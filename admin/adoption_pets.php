                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">Adoption Enquiry</h4>
                                                </div>
                                                <div class="table-responsive m-t-40">
                                                    <table id="myTable" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $sql = "SELECT users.*, pet_adoption.* FROM users INNER JOIN pet_adoption ON users.user_id=pet_adoption.user_id ";
                                                                $query = mysqli_query($db, $sql);

                                                                if (!mysqli_num_rows($query) > 0) {
                                                                    echo '<td colspan="6"><center>No Adoption</center></td>';
                                                                } else {
                                                                    while ($rows = mysqli_fetch_array($query)) {
                                                                            echo '<tr>
                                                                                ...
                                                                                <td>' . $rows['date'] . '</td>
																									 ...
																									 <td> 
																									 <a href="email_pet_adoption.php?petadoption_email='.$rows['pet_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td>
                                                                            </tr>';
                                                                    }
                                                                }
