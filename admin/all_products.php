                                            ...
                                            <div class="card card-outline-primary">
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>No products</center></td>';
														}
													else
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																				$mql="select * from product_category where product_category_id='".$rows['product_category_id']."'";
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr><td>'.$fetch['product_name'].'</td>
																								...
																								<center><img src="admin_img/products/'.$rows['image'].'" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
																								</div>
                                                                                                </td>																																					
																									 <td><a href="delete.php?product_del='.$rows['product_id'].'" onclick="return confirmDelete();" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_products.php?product_upd='.$rows['product_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';																									
																		}	
														}	
											?>
