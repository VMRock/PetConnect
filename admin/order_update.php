...
$remark=$_POST['remark'];
$query=mysqli_query($db,"insert into remark(form_id,order_status,remark) values('$form_id','$order_status','$remark')");
$sql=mysqli_query($db,"update product_orders set order_status='$order_status' where order_id='$form_id'");
                        ...
                        <form name="updateticket" id="updatecomplaint" method="post">
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td><select name="order_status" required="required">
