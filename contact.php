...
if(isset($_POST['submit'] )) 
{
	...
	else
	{
         ...
         elseif (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) 
        {
            ...
            $mql = "INSERT INTO contact(username,email,phone,message) VALUES('".$_POST['uname']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['message']."')";
	    mysqli_query($db, $mql);
...
<head>
    ...
    <link rel="icon" href="#">
    <title>Contact || Petconnect+ - Group5</title>
    <!-- Favicon -->
                                    ...
                                    <form action="" method="post">
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                ...
                                                <input class="form-control" type="text" name="uname" id="example-text-input" required pattern="[A-Za-z ]+">
                                            </div>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input class="form-control" type="text" placeholder="0xxxxxxxx" name="phone" id="example-tel-input-3" required>
                                            </div>
                                            <div class="form-group col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <p> <input type="submit" value="Submit" name="submit" class="btn theme-btn"><a href="contact.php" class="btn btn-inverse">Cancel</a> </p> </p>
                                            </div>
                                        </div>
                                    </form>
