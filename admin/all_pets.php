...
<div class="header">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">All pets</h4>
                                                </div>
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>No pets for adoption</center></td>';
														}
													else
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																				$mql="select * from pet_category where category_id='".$rows['category_id']."'";
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr>
																								...
																								<center><img src="admin_img/adoption/'.$rows['image'].'" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
																								</div></td>
																																														
                                                                                                </td>																																					
																									 <td><a href="delete.php?pet_del='.$rows['pet_id'].'" onclick="return confirmDelete();" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_pets.php?pet_upd='.$rows['pet_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';																								
																		}	
														}	
											?>
    ...
    function confirmDelete(petId) {
        if (confirm("Are you sure you want to update this user?")) {
            window.location.href = "delete.php?pet_del=" + petId;
        }
    }
</script>
