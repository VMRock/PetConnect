...
{	
		if(empty($_POST['category_name'])||empty($_POST['product_category_name']))
		{	
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO product_category(category_id,product_name,image) VALUE('".$_POST['category_name']."','".$product_category_name."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
												move_uploaded_file($temp, $store);
			  
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																 New pet category Added Successfully.
															</div>';
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-outline-primary">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="add_product_category.php" class="btn btn-inverse">Cancel</a>
                                        </div>
                                        </form>
                                    </div>
                                </div>
