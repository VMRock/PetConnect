...
<div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-paw f-s-40"></i>Welcome Admin</a>
                        ...
                        <div class="row">
                                ...
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from product_category";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                            <p class="m-b-0">Product Category</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="card p-30">
                                    <div class="media">
                                        <div class="media-left meida media-middle">
                                            <span><i class="fa fa-product-hunt f-s-40" aria-hidden="true"></i></span>
                                        </div>
                                        <div class="media-body media-text-right">
                        ...
                        <div class="col-md-3">
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from product_orders";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
                            ...
                            <div class="col-md-3">
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from product_orders WHERE order_status = 'in process' ";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
                            ...
                            <div class="col-md-3">
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from product_orders WHERE order_status = 'closed' ";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
                            ...
                            <div class="col-md-3">
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from product_orders WHERE order_status = 'rejected' ";
                                                $result=mysqli_query($db,$sql); 
                                                $rws=mysqli_num_rows($result);
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from pet_category";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                            <p class="m-b-0">Pet Categories</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card p-30">
                                    <div class="media">
                                        <div class="media-left meida media-middle">
                                            <span><i class="fa fa-paw f-s-40" aria-hidden="true"></i></span>
                                        </div>
                                        <div class="media-body media-text-right">
                                            <h2><?php $sql="select * from pets";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                            <p class="m-b-0">Pets for adoption</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card p-30">
                                    <div class="media">
                                        ...
                                        <div class="media-body media-text-right">
                                            <h2><?php 
                                        $result = mysqli_query($db, 'SELECT SUM(price) AS value_sum FROM product_orders WHERE order_status = "closed"'); 
