...
if (isset($_POST['submit'])) {
    if (empty($_POST['username']) || empty($_POST['password']) || empty($_POST['email'])) {
        ...
        if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
            ...
            $adminUser_upd = (isset($_GET['adminUser_upd'])) ? $_GET['adminUser_upd'] : 0;
            $escaped_username = mysqli_real_escape_string($db, $_POST['username']);
            $escaped_email = mysqli_real_escape_string($db, $_POST['email']);
            $hashed_password = md5($_POST['password']);
            
            $mql = "UPDATE users SET username='$escaped_username', email='$escaped_email', password='$hashed_password' WHERE user_id='$adminUser_upd'";
...
?>
                <head>
                    ...
                    <title>Update Admin Users</title>
            ...
            <div class="col-lg-12">
                <div class="card card-outline-primary">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Update Admin Users</h4>
                    </div>
                    <div class="card-body">
                        <?php $ssql ="select * from admin where user_id='$_GET[adminUser_upd]'";
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" class="form-control" value="<?php  echo $newrow['username']; ?>" placeholder="username" required>
                                        </div>
                                    </div>
                                </div>
