                                                ...
                                                <div class="table-responsive m-t-40">
                                                    <table id="myTable" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
												$sql="SELECT users.*, product_orders.* FROM users INNER JOIN product_orders ON users.user_id=product_orders.user_id ";
													...
													if(!mysqli_num_rows($query) > 0 )
														...
														{				
                                                            ...
                                                            <?php																									
																							...
																							?>
                                                            <td>
                                                                <a href="delete.php?order_del=<?php echo $rows['order_id'];?>" onclick="return confirmDelete();" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
                                                                <?php
																								echo '<a href="view_order.php?user_upd='.$rows['order_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td>
																									</tr>';
