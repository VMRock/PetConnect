...
if(isset($_POST['submit'] ))
{
	...
	$check_cat= mysqli_query($db, "SELECT category_name FROM pet_category where category_name = '".$_POST['c_name']."' ");
	...
	$mql = "INSERT INTO pet_category(category_name) VALUES('".$_POST['c_name']."')";
	mysqli_query($db, $mql);
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Add pet category</h4>
                                </div>
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="myTable" class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
												$sql="SELECT * FROM pet_category order by category_id desc";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['category_id'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 ...
																									 <td><a href="delete.php?cat_del='.$rows['category_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_pcategory.php?cat_upd='.$rows['category_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';							
																		}	
														}
											?>
