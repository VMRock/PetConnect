                                ...
                                <div class="col-lg-12">
                                    <div class="card card-outline-primary">
                                        <div class="card-header">
                                            <h4 class="m-b-0 text-white">All Contact Details</h4>
                                        </div>
                                            ...
                                            <table id="myTable" class="table table-bordered table-striped table-hover">
                                                ...
                                                <tbody>                                                   
                                                    <?php
														...
														{
															echo '<td colspan="7"><center>No messages</center></td>';
														}
													    else
														{				
															while($rows=mysqli_fetch_array($query))
															{
																...
																<td>'.$rows['message'].'</td>																								
																<td>'.$rows['date'].'</td>
																<td><a href="delete.php?contact_del='.$rows['contact_id'].'" onclick="return confirmDelete();" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
																</td></tr>';
															}	
														}
											        ?>
