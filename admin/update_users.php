...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update users set username='$_POST[uname]', first_name='$_POST[fname]', last_name='$_POST[lname]',email='$_POST[email]',phone='$_POST[phone]',password='".md5($_POST['password'])."' where user_id='$_GET[user_upd]' ";
	mysqli_query($db, $mql);
                                                            ...
                                                            <div class="row p-t-20">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="uname" class="form-control" value="<?php  echo $newrow['username']; ?>" placeholder="username" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group has-danger">
                                                                        ...
                                                                        <input type="text" name="fname" class="form-control form-control-danger" value="<?php  echo $newrow['first_name'];  ?>" placeholder="Jhon" required>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row p-t-20">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="lname" class="form-control" placeholder="doe" value="<?php  echo $newrow['last_name']; ?>" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group has-danger">
                                                                        ...
                                                                        <input type="text" name="email" class="form-control form-control-danger" value="<?php  echo $newrow['email'];  ?>" placeholder="example@gmail.com" required>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="password" class="form-control form-control-danger" value="<?php  echo $newrow['password'];  ?>" placeholder="password" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="phone" class="form-control form-control-danger" value="<?php  echo $newrow['phone'];  ?>" placeholder="phone" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
