                                                    ...
                                                    <?php
														...
														{				
															while($rows=mysqli_fetch_array($query))
															{
																...
																<td>'.$rows['address'].'</td>																								
																<td>'.$rows['date'].'</td>
																<td><a href="delete.php?user_del='.$rows['user_id'].'" onclick="return confirmDelete();" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
