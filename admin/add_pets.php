...
{	
		if(empty($_POST['pet_name'])||empty($_POST['breed'])||empty($_POST['gender'])||empty($_POST['age'])||$_POST['category_name']=='')
		{	
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "admin_img/adoption/".basename($fnew);                    
					...
					{        
									if($fsize>=1000000)
										...
										{																																			                                 
												$sql = "INSERT INTO pets(category_id,pet_name,breed,gender,age,image) VALUE('".$_POST['category_name']."','".$_POST['pet_name']."','".$_POST['breed']."','".$_POST['gender']."','".$_POST['age']."','".$fnew."')";  
												mysqli_query($db, $sql); 
												move_uploaded_file($temp, $store);
			  
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																 New pet for adoption Added Successfully.
															</div>';
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-outline-primary">
                                        <div class="card-header">
                                            <h4 class="m-b-0 text-white">Add pets for adoption</h4>
                                        </div>
                                        <div class="card-body">
                                            <form action='' method='post' enctype="multipart/form-data">
                                                <div class="form-body">
                                                    ...
                                                    <div class="row p-t-20">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-danger">
                                                                ...
                                                                <input type="text" name="breed" class="form-control form-control-danger">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="control-label">Select pet category</label>
                                                                <select name="category_name" class="form-control custom-select" data-placeholder="Choose a pet category" tabindex="1">
                                                                    <option>--Select pet category--</option>
                                                                    <?php $ssql ="select * from pet_category";
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="add_pets.php" class="btn btn-inverse">Cancel</a>
                                        </div>
                                        </form>
                                    </div>
                                </div>
