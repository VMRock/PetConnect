...
?>
                <head>
                    ...
                    <title>All Lost and Found</title>
...
<div class="header">
    ...
    <div class="card card-outline-primary">
        <div class="card-header">
            <h4 class="m-b-0 text-white">All Lost Pets</h4>
        </div>
        <div class="table-responsive m-t-40">
            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
    <?php
        $sql = "SELECT * FROM lost_and_found ORDER BY lostfound_id DESC";
        $query = mysqli_query($db, $sql);
        if (!mysqli_num_rows($query) > 0) {
            echo '<tr><td colspan="9"><center>No lost/found pets</center></td></tr>';
        } else {
                ...
                echo '<tr>
                    ...
                    <td>
                        <div class="col-md-3 col-lg-8 m-b-10">
                            <center>
                                <img src="admin/admin_img/lost/' . $row['image'] . '" class="img-responsive radius" style="max-height: 100px; max-width: 150px;" />
                            </center>
                        </div>
                    </td>
                    <td>' . $row['location'] . '</td>
                    <td>' . $row['lostfound_date'] . '</td>
                    <td>' . $row['phoneno'] . '</td>
                    <td>
                        <a href="delete.php?lostandfound_del=' . $row['lostfound_id'] . '" onclick="return confirmDelete();" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
                            <i class="fa fa-trash-o" style="font-size: 16px;"></i>
                        </a>
                        <a href="update_lostandfound.php?lostandfound_upd=' . $row['lostfound_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">
